...
**Status:** sport-side screen passed on September 19: opening-possession team scores first in 4,941/7,520 games (65.70%), a 31.41-point contrast. See the [screen result](../../reports/nba-first-possession-screen-2026-09-19.json). The [fixed book-side test](../../reports/nba-first-basket-backtest-2026-09-19.md) is complete: both declared candidates fail advancement. Tip-only has five bets; tip-plus-role loses in discovery and has worse pooled scoring than FanDuel. No edge established.

**Disposition:** close the two specifications in the [frozen price protocol](../nba-first-basket-price-protocol-2026-09-19.md) without retuning on the inspected discovery/replication periods. Any further first-basket investigation requires a distinct declared mechanism or additional data. Unknown quote jurisdiction and publisher outcome inspection remain explicit, and prospective promotion requirements are unchanged.
