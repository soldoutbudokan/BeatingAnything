...
September 13 fixed-definition follow-up in the pinned men's 2010s file: 4/13 exposed games were breaks (30.77%), versus 7/18 controls (38.89%), −8.12 points (descriptive 95% interval −42.39 to +26.15). The within-match residual contrast is −4.50 points (−39.01 to +30.00). This opposite but sparse result leaves the card unresolved: even both files together supply only 42 exposed cases, below the prewritten 50-case minimum. No pooled effect threshold, subgroup rescue, untouched holdout or price evidence is claimed. Stop archive expansion for this batch. See [fixed follow-up](../../reports/tennis-followup-2026-09-13.md).
