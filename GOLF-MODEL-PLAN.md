...
**September 19 redirection:** the user asked for a different creative market with historical prices. [NBA first-basket scorer](reports/nba-first-basket-source-2026-09-19.md) now supplies that data and is the active research direction. Preserve this golf plan and its completed screens; G11 remains parked on its own missing cross-course/round-score archive.
