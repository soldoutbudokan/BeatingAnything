...
**User priority, September 13:** work on a market with substantial season remaining. The active queue is now **NFL player/derivative props and NBA props for 2026–27**. Preserve the MLB position-player result, but defer further MLB research this season; its positive sport-side screen does not override the user's calendar preference. The [football wind/long-kick screen](reports/nfl-wind-kicks-2026-09-13.md) has completed and failed its fixed threshold. **Next executable test: NBA missing-creator assists**, using the historical sources in the [season and source checkpoint](docs/season-runway-2026-09-13.md) and the exact next steps in PROGRESS.md. Garbage-time receptions and backup-QB receiver roles are the next untested football cards once their activity/announcement evidence is available. Recheck runway as seasons advance. This priority supersedes the historical first-week order below, without reopening closed NFL main-line experiments or weakening evidence gates.
