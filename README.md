...
**Early payout scanner.** `python3 -m beating.early_payout scan` prices every moneyline covered by an early-payout rule against Pinnacle or the exchanges and publishes playable ones to `docs/index.html` (GitHub Pages). Setup, key and routine: [docs/early-payout-routine.md](docs/early-payout-routine.md).

**Second edge, September 22: bet365's standing Early Payout.** A moneyline pays once the team leads by 17 (NFL, college) or 20 (NBA). Play-by-play puts its value at 5–7% of an underdog's win probability for 20–30% dogs, more than bet365's historical 3.0–4.5% shading against Pinnacle on college underdogs. Expected edge is +1.2% to +4.4% per bet for teams with a 10–50% chance. Soccer's 2-goals-ahead version (bet365, FanDuel) is sized from 18,883 top-league goal timelines: bet365 prices it in, while FanDuel's value depends on its live prices. See the [early payout report](reports/early-payout-2026-09-22.md) for the break-even price tables.
...
**Latest result: [2026 first-basket validation](reports/nba-first-score-2026-validation-2026-09-19.md).** OddsPapi access works. A fixed 221-game acquisition yields 16 games with usable paired boards under an explicit provider-state assumption. The unchanged conversion model selects seven simulated bets: one win, six losses, **+3.80 units / +54.29% ROI**. One winner drives the result; all seven already show positive unconverted BetMGM EV. Quote timing and exact market identity remain conditional, and none of the paired boards meets the five-minute entry-age diagnostic. This is a positive small-sample lead, not an established edge. The acquisition is finished and **287 tests pass**. Next recover complete paired boards with original labels and contemporaneous clocks; preserve both this result and the earlier [2025 price test](reports/nba-first-score-wedge-backtest-2026-09-19.md).
