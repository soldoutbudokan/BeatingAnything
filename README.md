...
September 13: the [MLB position-player pitching screen](reports/mlb-position-pitching-2026-09-13.md) passed its sport-side threshold: 1.304 versus 0.639 runs in matched innings, a +0.664-run difference. FanDuel pricing is still untested. The [tennis follow-up](reports/tennis-followup-2026-09-13.md) records replication and a new negative screen; the [NFL price comparison](reports/nfl-price-screen-2026-09-13.md) found no qualifying disagreement. Research continuation is scheduled every six hours; see [PROGRESS.md](PROGRESS.md) for the exact next work and source limits.
